...
def get_all_users(secret, api_url, page_offset, results_per_page, result_offset, order_by_latest):
    data = {
            'api_key': secret,
            'page': page_offset,
...
def get_specific_user_post(secret, api_url, user_id, page_offset, results_per_page, result_offset):
    data = {
            'api_key': secret,
            'page': page_offset,
            'per_page': results_per_page,
...
def get_specific_user_newsfeed(secret, api_url, user_id, page_offset, results_per_page, result_offset):
    data = {
            'api_key': secret,
            'id': user_id,
            'page': page_offset,
...
def get_all_account_updates(secret, api_url, page_offset, results_per_page, result_offset, since_date, until_date, updated_since_date, updated_until_date):
    data = {
            'api_key': secret,
            'page': page_offset,
            'per_page': results_per_page,
...
def get_all_account_pulses(secret, api_url, page_offset, results_per_page, result_offset, order_by_latest, since_date, until_date):
    data = {
            'api_key': secret,
            'page': page_offset,
            'per_page': results_per_page,
...
def delete_pulse(secret, api_url, pulse_id, archive_pulse):
    data = {
            'api_key': secret,
            'id': pulse_id,
           }
...
def get_pulse_subscribers(secret, api_url, pulse_id, page_offset, results_per_page, result_offset)
    data = {
            'api_key': secret,
           }
...
def add_pulse_subscriber(secret, api_url, pulse_id, user_id, as_admin):
    data = {
            'api_key': secret,
           }
    endpoint = f'/v1/pulses/{pulse_id}/subscribers.json'
...
def create_pulse_note(secret, api_url, pulse_id, note_title, note_content, owners_only, user_id, create_update):
    data = {
            'api_key': secret,
           }
    endpoint = '/v1/pulses/{pulse_id}/notes.json'
...
def get_pulse_updates(secret, api_url, pulse_id, results_per_page, update_limit):
    data = {
            'api_key': secret,
           }
...
def get_all_boards(secret, api_url, results_per_page, only_globals, order_by_latest):
    data = {
            'api_key': secret,
            'per_page': results_per_page,
...
def get_all_board_groups(secret, api_url, board_id, show_archived, show_deleted):
    data = {
            'api_key': secret,
            'board_id': board_id,
...
def get_all_board_columns(secret, api_url, board_id, all_columns):
    data = {
            'api_key': secret,
            'board_id': board_id,
...
def get_pulse_column_value(secret, api_url, board_id, column_id, pulse_id, return_as_array):
    data = {
            'api_key': secret,
            'board_id': board_id,
            'column_id': column_id,
...
def get_board_pulses(secret, api_url, board_id, page_offset, results_per_page, order_by):
    data = {
            'api_key': secret,
            'board_id': board_id,
            'page': page_offset,
...
def create_pulse(secret, api_url, board_id, user_id, pulse_name, pulse_hash='', pulse_photo_from_url='', pulse_update_hash='', pulse_update_text='', pulse_group_id='', add_to_bottom):
    data = {
            'api_key': secret,
            'board_id': board_id,
            'user_id': user_id,
...
def move_pulse(secret, api_url, board_id, user_id, group_id, pulse_ids, destination_board_id, force_move_to_board):
    data = {
            'api_key': secret,
            'board_id': board_id,
            'user_id': user_id,
...
def add_board_subscriber(secret, api_url, board_id, user_id, as_admin):
    data = {
            'api_key': secret,
            'board_id': board_id,
            'user_id': user_id,
